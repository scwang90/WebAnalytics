...
public class BrowserVersion {
	...
	public static final Pattern IEPattern = Pattern.compile("rv:([\\d\\w\\.\\-]+)", Pattern.CASE_INSENSITIVE);
	public static final Pattern SougouPattern = Pattern.compile("(\\d+[\\.\\d]+)", Pattern.CASE_INSENSITIVE);
