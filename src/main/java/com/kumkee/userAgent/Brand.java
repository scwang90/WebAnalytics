...
public enum Brand {
    ...
    Vivo("vivo","VIVO","Vivo","\\b(vivo[\\w\\-\\. ]*) build"),
    HongMi("hongmi","HM","红米","\\b(hm[\\w\\-\\. ]*) build"),
    XiaoMi("xiaomi","XM","小米","\\b(mi[\\w\\-\\. ]*) build"),
    XiaoMi1("xiaomi","XM","小米","(xiaomi)"),

    Smartisan("smartisan","SM","锤子","\\b(sm[\\w\\-\\. ]*) build\\b"),
    Nokia("nokia","NK","诺基亚","(nokia\\s*[\\w\\.\\-]+)"),
    Nokia1("nokia","NK","诺基亚","(symbian)"),

    Apple("apple","AP","苹果","(iphone)|(ipad)|\\b(mac)\\b|(apple)\\b|\\b(ios)\\b"),
