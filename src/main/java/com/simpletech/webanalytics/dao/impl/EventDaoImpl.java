...
public class EventDaoImpl extends BaseDaoImpl<Event> implements EventDao{
	...
	@Override
	public List<EventPeriodValue> eventMonth(int idsite, String category, Date start, Date end, int limit, int skip) throws Exception {
		return mapper.eventMonth(idsite, category, start, end, limit, skip);
	}

	@Override
	public List<EventPeriodValue> eventWeek(int idsite, String category, Date start, Date end, int limit, int skip) throws Exception {
		return mapper.eventWeek(idsite, category, start, end, limit, skip);
	}

	@Override
	public List<EventPeriodValue> eventDay(int idsite, String category, Date start, Date end, int limit, int skip) throws Exception {
		return mapper.eventDay(idsite, category, start, end, limit, skip);
	}

	@Override
	public List<EventPeriodValue> eventHour(int idsite, String category, Date start, Date end, int limit, int skip) throws Exception {
