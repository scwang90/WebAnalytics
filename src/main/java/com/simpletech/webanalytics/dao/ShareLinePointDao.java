...
/**
 * 数据库表t_share_line_point的Dao接口
 * @author 树朾
 * @date 2015-10-20 14:49:10 中国标准时间
 */
public interface ShareLinePointDao extends BaseDao<ShareLinePoint>{
	 ...
	 * @return 数据对象 or null
	 */
	ShareLinePoint findById(Object id) throws Exception;
	/**
	 * 获取全部数据
	 * @return 全部所有数据
	 */
	List<ShareLinePoint> findAll() throws Exception;
	/**
	 * 分页查询数据
	 * @param limit 分页最大值
	 * @param start 开始编号
	 * @return 分页列表数据
	 */
	List<ShareLinePoint> findByPage(int limit, int start) throws Exception;
