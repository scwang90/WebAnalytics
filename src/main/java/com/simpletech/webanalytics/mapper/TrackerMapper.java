...
public interface TrackerMapper {
    ...
    Visit getVisitById(@Param("id") String id) throws Exception;
    ...
    Action getActionHalfHour(@Param("siteId") String siteId, @Param("idvtor") String idvtor) throws Exception;
    ...
    int updateVisitPageView(@Param("id") String idvisit, @Param("idurlExit") String idurlExit, @Param("idtitleExit") String idtitleExit) throws Exception;
