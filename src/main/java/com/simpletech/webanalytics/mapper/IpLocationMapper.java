...
public interface IpLocationMapper extends MybatisMultiDao<IpLocation>{
	 ...
	 * @return 改变的行数
	 */
	@Insert("INSERT INTO t_ip_location ( id , ip , tb_country , tb_province , tb_city , tb_districk , tb_isp , bd_country , bd_province , bd_city , bd_districk , bd_isp , create_time , tx_districk , tx_city , tx_country , tx_isp , tx_province , update_time ) VALUES ( #{id} , #{ip} , #{tbCountry} , #{tbProvince} , #{tbCity} , #{tbDistrick} , #{tbIsp} , #{bdCountry} , #{bdProvince} , #{bdCity} , #{bdDistrick} , #{bdIsp} , #{createTime} , #{txDistrick} , #{txCity} , #{txCountry} , #{txIsp} , #{txProvince} , #{updateTime} )")
	 ...
	 * @return 分页列表数据
	 */
	@Select("SELECT id , ip , tb_country tbCountry , tb_province tbProvince , tb_city tbCity , tb_districk tbDistrick , tb_isp tbIsp , bd_country bdCountry , bd_province bdProvince , bd_city bdCity , bd_districk bdDistrick , bd_isp bdIsp , create_time createTime , tx_districk txDistrick , tx_city txCity , tx_country txCountry , tx_isp txIsp , tx_province txProvince , update_time updateTime FROM t_ip_location ${order} LIMIT ${start},${limit}")
	 ...
	 * @return 符合条件的列表数据
	 */
	@Select("SELECT id , ip , tb_country tbCountry , tb_province tbProvince , tb_city tbCity , tb_districk tbDistrick , tb_isp tbIsp , bd_country bdCountry , bd_province bdProvince , bd_city bdCity , bd_districk bdDistrick , bd_isp bdIsp , create_time createTime , tx_districk txDistrick , tx_city txCity , tx_country txCountry , tx_isp txIsp , tx_province txProvince , update_time updateTime FROM t_ip_location ${where} ${order}")
	 ...
	 * @return 符合条件的列表数据
	 */
	@Select("SELECT id , ip , tb_country tbCountry , tb_province tbProvince , tb_city tbCity , tb_districk tbDistrick , tb_isp tbIsp , bd_country bdCountry , bd_province bdProvince , bd_city bdCity , bd_districk bdDistrick , bd_isp bdIsp , create_time createTime , tx_districk txDistrick , tx_city txCity , tx_country txCountry , tx_isp txIsp , tx_province txProvince , update_time updateTime FROM t_ip_location ${where} ${order} LIMIT ${start},${limit}")
	 ...
	 * @return 返回符合条件的数据列表
	 */
	@Select("SELECT id , ip , tb_country tbCountry , tb_province tbProvince , tb_city tbCity , tb_districk tbDistrick , tb_isp tbIsp , bd_country bdCountry , bd_province bdProvince , bd_city bdCity , bd_districk bdDistrick , bd_isp bdIsp , create_time createTime , tx_districk txDistrick , tx_city txCity , tx_country txCountry , tx_isp txIsp , tx_province txProvince , update_time updateTime FROM t_ip_location WHERE ${propertyName}=#{value} ${order}")
