...
public enum Browser {
    ...
    MSIEMobile("MSIEMobile", "IEMB", "IE移动版", "iemobile/(\\S+)"),
    Msie11("msie11", "IE11", "Internet Explorer 11", "\\bmsie[ :]+(11\\S+)|rv:(1\\S+)"),
    Msie10("msie10", "IE10", "Internet Explorer 10", "\\bmsie[ :]+(10\\S+)"),
    Msie5("msie5", "IE5", "Internet Explorer 5", "\\bmsie[ :]+(5\\S+)"),
    Msie6("msie6", "IE6", "Internet Explorer 6", "\\bmsie[ :]+(6\\S+)"),
    Msie7("msie7", "IE7", "Internet Explorer 7", "\\bmsie[ :]+(7\\S+)"),
    Msie8("msie8", "IE8", "Internet Explorer 8", "\\bmsie[ :]+(8\\S+)"),
    Msie9("msie9", "IE9", "Internet Explorer 9", "\\bmsie[ :]+(9\\S+)"),
